...
Lambda.prototype.run = function (program) {
  ...
  var splitHandler = program.handlfer.split('.');
      ...
      archive(program, codeDirectory, function (err, buffer) {
        ...
        async.map(regions, function (region, cb) {
          ...
          var lambda = new aws.Lambda({
            apiVersion: '2015-07-11'
          });

            // Check If Lambda Function Exists Already
            console.log("Check If Lambda Function Exists Already");
            lambda.getFunction({
                ...
                if (!data || !data.Code) {
                    ...
                    console.log('Lambda: Uploading your Lambda Function to AWS Lambda with these parameters: ');
                    console.log(params);
                    ...
                    console.log('Lambda: Deleting existing Lambda function...');
                    ...
                    lambda.deleteFunction({
                        ...
                        console.log('Lambda: Re-uploading your Lambda Function to AWS Lambda with these parameters: ');
                        console.log(params);
