...
Lambda.prototype._postInstallScript = (program, codeDirectory) => {
...
Lambda.prototype._archive = function (program) {
  ...
  const functionName = program.prebuiltDirectory
    ? '_archivePrebuilt' : '_buildAndArchive'
  return this[functionName](program)
}
