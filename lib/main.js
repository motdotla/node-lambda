...
Lambda.prototype._updateScheduleEvents = function (scheduleEvents, functionName, scheduleList, cb) {
  return async.series(scheduleList.map(function(schedule) {
    return function(_cb) {
      const params = Object.assign(schedule, { FunctionName: functionName });
        ...
        if (err) {
          ...
          return _this._uploadNew(lambda, params, function(err, results) {
            ...
            async.parallel([
              ...
              function(_callback) {
                _this._updateScheduleEvents(scheduleEvents, params.FunctionName, eventSourceList.ScheduleEvents, function(err, results) {
