...
Lambda.prototype._runHandler = function (handler, event, runtime) {
  ...
  var context = {
    ...
    fail: function (error) {
      if(isNode43) console.log('context.fail() is deprecated with Node.js 4.3 runtime');
      callback(error);
    },
    done: function () {
      if(isNode43) console.log('context.done() is deprecated with Node.js 4.3 runtime');
      callback();
    }
  };
