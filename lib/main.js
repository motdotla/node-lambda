...
Lambda.prototype._params = function (program, buffer) {
  ...
  if (program.deadLetterConfigTargetArn) {
    /*
     * TODO:
     * What do you do when you want to erase
     * DeadLetterConfig settings?
     * Passing empty characters cancels the setting
     * but does not enter this if statement.
     */
